...
class Activity_pemeriksaan_privasi : AppCompatActivity() {
    private lateinit var binding: ActivityPemeriksaanPrivasiBinding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)

        binding = ActivityPemeriksaanPrivasiBinding.inflate(layoutInflater)
